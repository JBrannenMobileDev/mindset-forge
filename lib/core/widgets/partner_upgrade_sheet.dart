        ...
        child: Column(
          ...
          children: [
            ...
            _benefit(Icons.chat_bubble_outline_rounded, 'Unlimited AI coaching',
                '24/7 personalized guidance built on six mindset classics'),
            _benefit(Icons.track_changes_rounded, 'Full goal & habit system',
                'Track unlimited goals and build powerful habits'),
            _benefit(Icons.auto_graph_rounded, 'Affirmations & visualizations',
